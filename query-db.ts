...
const main = async () => {
    ...
    try {
        ...
        fs.writeFileSync(path.resolve(__dirname, "query_success.json"), JSON.stringify(response, null, 2));
        ...
        fs.writeFileSync(path.resolve(__dirname, "query_error.json"), JSON.stringify(errObj, null, 2));
