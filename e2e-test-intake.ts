...
const testPayload = {
	...
	currentCrm: "HubSpot",
	icpDescription:
		"B2B SaaS companies with 10-50 employees looking to scale their lead generation",
	highIntentSources: "LinkedIn Sales Navigator, Product Hunt, TechCrunch",
	scrapingInstructions:
		"Scrape LinkedIn for SaaS founders in San Francisco Bay Area",
...
async function runTest() {
	...
	try {
		...
		if (response.ok && result.success) {
			...
			console.log(
				`   - Business Types: ${testPayload.businessType.join(", ")}`,
			);
