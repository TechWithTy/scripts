...
const createTestLead = async () => {
    ...
    const payload: any = {
        ...
        properties: {
            ...
            "Start Date ": { // Note the trailing space
    ...
    try {
        ...
        fs.writeFileSync(path.resolve(__dirname, "final_creation_success.json"), JSON.stringify(response, null, 2));
        ...
        fs.writeFileSync(path.resolve(__dirname, "final_creation_error.json"), JSON.stringify(error, null, 2));
    }
};
